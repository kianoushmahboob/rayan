    ...
    >
      <v-card>
       ...
       <img src="/warning.png" class="dialogWarningImg">   
            ...
            <v-card-text>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
        </v-card-text>
  ...
  methods: {
     onScroll() {
      ...
      if (currentScrollPosition > 120) {
        document.getElementById("HeaderMangerProfileId").classList.add("HeaderMangerProfileFixed");
      }
      else if (currentScrollPosition == 0) { 
        document.getElementById("HeaderMangerProfileId").classList.remove("HeaderMangerProfileFixed");
      }
